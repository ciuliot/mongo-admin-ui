...
/**
 * Wraps information for unified response from server controller.
 * @class ControllerResponse
 */
export class ControllerResponse {
    /**
     * @method constructor
     * @param error {Object} Indicates if there was error while performing operation in controller or `null` if operation was processed succesfully.
 ...
 */
export class AbstractController extends locomotive.Controller {
    /**
    ...
    jsonResponse(err: any, result?: any): void {
        this.res.json(new ControllerResponse(err, result));
    }
